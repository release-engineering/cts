...
def upgrade():
    op.add_column('composes', sa.Column('base_product_name', sa.String(), nullable=True))
    op.add_column('composes', sa.Column('base_product_short', sa.String(), nullable=True))
    op.add_column('composes', sa.Column('base_product_type', sa.String(), nullable=True))
    op.add_column('composes', sa.Column('base_product_version', sa.String(), nullable=True))
    ...
    op.add_column('composes', sa.Column('release_internal', sa.Boolean(), nullable=True))
    op.add_column('composes', sa.Column('release_is_layered', sa.Boolean(), nullable=True))
