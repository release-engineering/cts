...
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), '../cts')))
...
latex_documents = [
    (master_doc, 'CTS.tex', 'CTS Documentation',
...
man_pages = [
    (master_doc, 'cts', 'CTS Documentation',
     [author], 1)
]
